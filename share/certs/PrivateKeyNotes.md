...
unlocked to sign the Zioncoin-Qt.app bundle.
...
allowing somebody to distribute a Zioncoin-Qt.app or Zioncoin-qt-setup.exe with a valid
...
that the Zioncoin-qt.exe file inside the installer had not been tampered with.
