Zioncoin Core version 0.13.2 is now available from:

  <https://Zioncoin.org/bin/Zioncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update Zioncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Zioncoin-tx to create v2 transactions (sysdrak)
