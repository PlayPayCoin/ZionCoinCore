...
This document provides guidelines for internationalization of the Zioncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Zioncoin_en.ts` remains unchanged.
