Zioncoin-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/Zioncoin/files/Zioncoin/Zioncoin-0.8.2/
...
MacOSX:
* OSX support for click-to-pay (Zioncoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Zioncoin-Qt debug
console will cause Zioncoin-Qt to crash. Run Zioncoin-Qt with the -server command-line
