Zioncoin Core version 0.9.4 is now available from:

  https://Zioncoin.org/bin/0.9.4/
...
this update is incompatible with the Zioncoin system and could lead to consensus
forks.

Zioncoin Core released binaries from https://Zioncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Zioncoin Core

upgrade to Zioncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
