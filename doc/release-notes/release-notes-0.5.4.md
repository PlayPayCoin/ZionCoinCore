Zioncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Zioncoin/files/Zioncoin/Zioncoin-0.5.4/
...
http://gitorious.org/Zioncoin/Zioncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Zioncoin-Qt notifications under Growl 1.3.
Increase required age of Zioncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZioncoin properly when installing Zioncoin-Qt over it. (Windows)
