Zioncoin Core version 0.10.4 is now available from:

  <https://Zioncoin.org/bin/Zioncoin-core-0.10.4/>
...
- #6953 `43c2789` Split Zioncoin-tx into its own package
- #6953 `dfe0d4d` Include Zioncoin-tx binary on Debian/Ubuntu
