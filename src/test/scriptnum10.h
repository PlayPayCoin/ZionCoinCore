...
#ifndef Zioncoin_TEST_SCRIPTNUM10_H
#define Zioncoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Zioncoin Core 0.10.0, for cross-comparison.
 */
public:
